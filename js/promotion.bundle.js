! function(t) {
    function e(e) {
        for (var a, r, s = e[0], l = e[1], c = e[2], f = 0, d = []; f < s.length; f++) r = s[f], Object.prototype.hasOwnProperty.call(n, r) && n[r] && d.push(n[r][0]), n[r] = 0;
    ...
    "use strict";
    (function(t) {
        i(8), i(9), i(10), i(11), i(12), i(13), i(15);
        t((function() {
            ...
            t(".opennav").on("click", (function(e) {
                e.preventDefault(), a ? (t(".sub-nav-mb").removeClass("Open"), t(".opennav").removeClass("toclose is-active"), a = !1) : (t(".sub-nav-mb").addClass("Open"), t(".opennav").addClass("toclose is-active"), a = !0)
            ...
            function o(t, e, i) {
                if (e.files && e.files[0]) {
                    ...
                    a.onload = function(e) {
                        t.eq(i).children("img").attr("src", e.target.result), t.eq(i).children("img").show()
            ...
            t(".osdetect").length > 0 && t(".osdetect").each((function() {
                ...
                t(".prize__thumb").removeClass("active"), t(this).addClass("active");
                var e = t(this).attr("data-thumbdesktop"),
                    i = t(this).attr("data-thumbmobile");
                t("#fullPrizeDesktop").attr("src", e), t("#fullPrizeMobile").attr("src", i)
            })), t((function() {
                ...
                return !!(t(this).is(":last-child") && t(this).parents(".pet-container").length > 0) || (function(e) {
                    t(e).closest(".tab").find("li").removeClass("active"), t(e).addClass("active");
                    var i = t(e).find("a").attr("href");
                    t(e).closest(".tab-wrapper").find(".tab-item").hide(), t(i).show(), t(e).closest(".tab-wrapper").find(".tab-wrapper").each((function(e, i) {
                        t(this).children().closest(".tab").find(".tab-name").first().trigger("click")
                    }))
                }(this), !1)
    ...
    (function(t) {
        t.fn.toggleClassname = function(e) {
            var i = {
                ...
                a = t.extend(i, e);
            a.obj.on("click", t => {
                t.preventDefault(), a.before(), a.toggle.forEach((function(t) {
        ...
        t.fn.scalePlatform = function(e) {
            ...
            t(window).on("resize", (function() {
                var e = t(window).innerWidth(),
                    ...
                    r = 1,
                    s = 0;
                !o && e > a.designSafe.desktop ? ("margin", s = -1 * (e - a.designSafe) / 2) : ("scale", r = o() ? e / a.designWidth.mobile : e / a.designWidth.desktop);
                var l = n * r;
                a.obj.css({
                    display: "block",
                    transform: "scale(" + r + ")",
    ...
    (function(t) {
        ...
        t.fn.lightBox = function(i) {
            ...
            n.obj.on("click", e => {
                e.preventDefault(), t("html").addClass("popup-opened"), "youtube" == t(this).data("lightbox-type") && null == ytPlayer[t(this).attr("href")] && (ytPlayer[t(this).attr("href")] = YoutubePlayer(t(this).attr("href").substring(1) + "_embed", {
                ...
                })), t(t(this).attr("href")), t(t(this).attr("href")).addClass("active"), t(t(this).attr("href")).animate(n.animate), "youtube" == t(this).data("lightbox-type") && ytPlayer[t(this).attr("href")].playVideo()
            })
        }, t("body").on("click", ".close", (function() {
            t("html").removeClass("popup-opened"), t(this).parents(".popup").removeClass("active"), t(this).parent().parent().removeClass("active"), t(this).parent().removeClass("active"), t(this).parent().parent().hasClass("popup--open-video") && ytPlayer["#" + t(this).parent().parent().attr("id")].pauseVideo()
        })), t("body").on("click", ".popup__background", (function() {
            t("html").removeClass("popup-opened"), t(this).parent().removeClass("active"), t(this).parent().hasClass("popup--open-video") && ytPlayer["#" + t(this).parent().attr("id")].pauseVideo()
        }))
    }).call(this, i(0))
}, function(t, e, i) {
    "use strict";
